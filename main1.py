...
'bihar','bihar','bridge','cat', 'chandigarh', 'chennai', 'christmas', 'church', 'clinic', 'coconut', 'crocodile','dussehra',
...
while 1:
  image   = "signlang.png"
  msg="WELCOME! SIGN LANGUAGE CONVERTION FROM AUDIO TO TEXT AND SIGN LANGUAGE"
